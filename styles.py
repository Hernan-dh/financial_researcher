"""Stock Picker visual identity adapted for financial research."""
...
.financial-bar-1 { width:100%; background:var(--acid); } .financial-bar-2 { width:70%; background:#209dd7; } .financial-bar-3 { width:45%; background:var(--orange); }
.financial-headings h1 { margin:0!important; color:var(--text)!important; font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif!important; font-size:clamp(1.55rem,3.6vw,2.35rem)!important; font-weight:900!important; line-height:.95!important; letter-spacing:-.045em!important; }
.financial-sep { margin:0 .04em; color:var(--acid); font-weight:300; }
.financial-headings p { margin:.55rem 0 0!important; color:var(--muted)!important; font:400 .7rem var(--mono)!important; letter-spacing:.22em; }
...
.company-examples,.company-examples>div,.company-examples-label,.company-examples-label>div { margin:0!important; padding:0!important; border:0!important; background:transparent!important; box-shadow:none!important; }
.company-examples-label { padding:7px 0!important; }
.company-examples-label p { margin:0!important; color:var(--muted)!important; font:400 9px var(--mono)!important; letter-spacing:.08em; text-transform:uppercase; }
.company-examples { gap:8px!important; margin-bottom:12px!important; }
.company-examples button { min-height:46px!important; height:auto!important; padding:8px 12px!important; border:1px solid var(--border)!important; background:var(--surface)!important; color:var(--text)!important; font:500 12px/1.35 var(--sans)!important; text-align:left!important; white-space:normal!important; }
.company-examples button:hover { border-color:var(--acid)!important; color:var(--acid)!important; }
.company-input-row { gap:0!important; margin:0!important; } .company-input-row button { min-width:118px!important; }
...
#financial-chat-en,#financial-chat-es { height:520px!important; min-height:520px!important; border:1px solid var(--border)!important; background:rgb(24 28 25 / 94%)!important; box-shadow:18px 18px 0 rgb(0 0 0 / 18%)!important; }
...
@media (max-width:640px) { .gradio-container{padding:22px 14px 34px!important} #title-row{flex-wrap:wrap!important;gap:16px!important} #language-control{width:100%!important;margin-left:0!important} .company-examples{flex-direction:column!important} #financial-chat-en,#financial-chat-es{height:500px!important;min-height:500px!important;box-shadow:8px 8px 0 rgb(0 0 0 / 18%)!important} }
"""
...
#financial-chat-en .icon-button, #financial-chat-es .icon-button,
#financial-chat-en button.icon-button, #financial-chat-es button.icon-button {
...
.financial-headings h1 { font-size:clamp(1.8rem,4vw,2.6rem)!important; }
...
.company-examples button { font:500 14px/1.45 var(--sans)!important; text-transform:none!important; }
#language-label p,.company-examples-label p { font-size:10px!important; }
